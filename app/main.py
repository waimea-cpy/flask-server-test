...
def hello():
    ...
    return render_template("pages/home.jinja", name=name)
...
def profile():
    ...
    return render_template("pages/profile.jinja", user=user)
...
def list_users():
    ...
    return render_template("pages/users.jinja", users=users)
...
def show_user(id: int):
    ...
    return render_template("pages/users.jinja", users=users, focus_user=id)
...
def user_details(id: int):
    ...
    return render_template("components/user.jinja", user=user, things=things)
